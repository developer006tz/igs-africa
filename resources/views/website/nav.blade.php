<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a href="{{route('website.index')}}" class="flex items-center">
      <h1><span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"><b class="text-blue-900"></b><b class="text-green-900">@yield('heading')</b></span></h1>
  </a>
