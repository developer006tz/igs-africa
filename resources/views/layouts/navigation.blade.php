    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                ...
                @can('view-any', App\Models\Igsstation::class)
                <x-responsive-nav-link href="{{ route('igsstations.index') }}">
                Igsstations
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Corsstation::class)
                <x-responsive-nav-link href="{{ route('corsstations.index') }}">
                Corsstations
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
                ...
                @endcan
                @can('view-any', App\Models\SystemDescription::class)
                <x-responsive-nav-link href="{{ route('system-descriptions.index') }}">
                System Descriptions
                </x-responsive-nav-link>
                @endcan
