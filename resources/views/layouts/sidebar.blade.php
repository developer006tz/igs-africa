...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('/') }}" class="brand-link">
        ...
        <span class="brand-text font-weight-light">igsafrica</span>
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('igsstations.index') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('corsstations.index') }}" class="nav-link">
                                    <i class="nav-icon icon ion-md-radio-button-off"></i>
                                    <p>Corsstations</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('system-descriptions.index') }}" class="nav-link">
                                    <i class="nav-icon icon ion-md-radio-button-off"></i>
                                    <p>System Descriptions</p>
                                </a>
                            </li>
                            @endcan
                    </ul>
